...
class coursesignup
{
    ...
    //ophalen cursus data uit de database en deze returnen
    function getCursus(){
    ...
    //de inschrijving in de database stoppen
    ...
    //berekenen aantal deelnemers van de cursus
    //parameter = naam van de cursus
